...
# Han test
python val_ROI_video_sperm_VSL_selection.py --video test-videoes/20241105_115426118.mp4 --output output-videoes/20241105_115426118_Sperm_VSL_Morphy_Selection.mp4 --det_engine yolo_weights/best.engine --seg_model ADSCNet_sperm_ROINAHead_250707 --seg_engine model_fp32.engine --conf 0.25 

python val_ROI_video_sperm_VSL_selection.py --video E:\\MMRL-LAB-NAS\\Han-Workspace\\19201200-savedImg\\capture_20250808-225344.mp4 --output E:\\MMRL-LAB-NAS\\Han-Workspace\\19201200-savedImg\\results\\capture_20250808-225344_Sperm_VSL_Morphy_Selection.mp4 --det_engine yolo_weights/best.engine --seg_model ADSCNet_sperm_ROINAHead_250707 --seg_engine model_fp32.engine --conf 0.25 

python val_ROI_video_sperm_VSL_selection.py --video E:\\MMRL-LAB-NAS\\Han-Workspace\\19201200-savedImg\\capture_20250808-225705.mp4 --output E:\\MMRL-LAB-NAS\\Han-Workspace\\19201200-savedImg\\results\\capture_20250808-225705_Sperm_VSL_Morphy_Selection.mp4 --det_engine yolo_weights/best.engine --seg_model ADSCNet_sperm_ROINAHead_250707 --seg_engine model_fp32.engine --conf 0.25 

python val_ROI_video_sperm_VSL_selection.py --video E:\\MMRL-LAB-NAS\\Han-Workspace\\19201200-savedImg\\capture_20250808-230336.mp4 --output E:\\MMRL-LAB-NAS\\Han-Workspace\\19201200-savedImg\\results\\capture_20250808-230336_Sperm_VSL_Morphy_Selection.mp4 --det_engine yolo_weights/best.engine --seg_model ADSCNet_sperm_ROINAHead_250707 --seg_engine model_fp32.engine --conf 0.25 

# xiangya test
python val_ROI_video_sperm_VSL_selection.py --video E:\\MMRL-LAB-NAS\\Han-Workspace\\0819\\2022_8_19_13_47_9.avi --output E:\\MMRL-LAB-NAS\\Han-Workspace\\0819\\results\\2022_8_19_13_47_9_Sperm_VSL_Morphy_Selection.mp4 --det_engine yolo_weights/best.engine --seg_model ADSCNet_sperm_ROINAHead_250707 --seg_engine model_fp32.engine --conf 0.25 

python val_ROI_video_sperm_VSL_selection.py --video E:\\MMRL-LAB-NAS\\Han-Workspace\\0819\\2022_8_19_13_51_8.avi --output E:\\MMRL-LAB-NAS\\Han-Workspace\\0819\\results\\2022_8_19_13_51_8_Sperm_VSL_Morphy_Selection.mp4 --det_engine yolo_weights/best.engine --seg_model ADSCNet_sperm_ROINAHead_250707 --seg_engine model_fp32.engine --conf 0.25 

# 20250813 Swim Up Using
python val_ROI_video_sperm_VSL_selection.py --video test-videoes\\swimUpUsing_5min.mp4 --output E:\\MMRL-LAB-NAS\\Han-Workspace\\20250813-SpermVideo-DeadMostly\\results\\swimUpUsing_5min_Sperm_VSL_Morphy_Selection.mp4 --det_engine yolo_weights/best.engine --seg_model ADSCNet_sperm_ROINAHead_250707 --seg_engine model_fp32.engine --conf 0.25 
...
class SpermTracker:
    ...
    def update_sperm_data(self, active_tracks, frame_shape):
        ...
        for track_id in inactive_ids:
            ...
            # Reset best sperm if it becomes inactive
            if self.best_sperm_id == track_id:
                self.best_sperm_id = None
    
    def select_best_sperm(self):
        """Always select the sperm with the highest current VSL as the best sperm"""
        valid_sperm = []
        
        for sperm_id, sperm in self.sperm_data.items():
            # Only consider sperm with sufficient tracking history and not near boundary
        ...
        # Sort by VSL (descending order) and always select the fastest one
        valid_sperm.sort(key=lambda x: x[1], reverse=True)
        
        # Always update to the sperm with highest VSL
...
def draw_best_sperm_only(img, sperm_tracker, segmentation_results, roi_size=64):
    """Draw only the best sperm with fixed 64x64 detection box and segmentation - without label text"""
...
def process_video(det_engine, seg_engine, video_path, output_path, det_class_names, 
    ...
    while True:
        ...
        # Select best sperm (always the one with highest VSL)
...
Note: Always displays the sperm with the highest current VSL value.
The best sperm selection is updated every frame based on current VSL rankings.
"""
